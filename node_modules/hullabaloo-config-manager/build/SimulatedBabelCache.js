...
(function (Configuration) {
    Configuration[Configuration["Forever"] = 0] = "Forever";
    Configuration[Configuration["Never"] = 1] = "Never";
    Configuration[Configuration["Using"] = 2] = "Using";
})(Configuration || (Configuration = {}));
class SimulatedBabelCache {
    constructor(data) {
        ...
        const assertNotForever = () => {
            if (this.configuration === Configuration.Forever)
                throw new Error('Caching has already been configured with .forever()');
        };
        const assertNotNever = () => {
            if (this.configuration === Configuration.Never)
    ...
    hash() {
        if (!this.sealed)
            throw new Error('seal() must be called before invoking hash()');
        if (this.computedHash)
            return this.computedHash.value;
        let value = null;
...
exports.default = SimulatedBabelCache;
//# sourceMappingURL=SimulatedBabelCache.js.map